...
class uagent_info {
  ...
  function DetectIpad(){
    return ( stripos( $this->useragent , $this->deviceIpad )>-1
             && $this->DetectWebkit() );
  }
  ...
  function DetectIphoneOrIpod(){
     ...
     return ( stripos( $this->useragent , $this->deviceIphone )>-1
  ...
  function DetectIos(){
    return ( $this->DetectIphoneOrIpod()
             || $this->DetectIpad() );
  }
  ...
  function DetectAndroid(){
    return ( stripos( $this->useragent , $this->deviceAndroid )>-1
             || $this->DetectGoogleTV()
  ...
  function DetectBlackBerry(){
    return ( stripos( $this->useragent , $this->deviceBB )>-1
  ...
  function DetectBlackBerryTouch(){
    return ( stripos( $this->useragent , $this->deviceBBStorm )>-1
  ...
  {
    return ( $this->DetectBlackBerry() &&
             !$this->DetectBlackBerryWebKit() //Disambiguate for BlackBerry OS 6 or 7 (WebKit) browser
  ...
  function DetectPalmOS(){
    ...
    return ( ( stripos( $this->useragent , $this->devicePalm )>-1
               || stripos( $this->useragent , $this->engineBlazer )>-1
               || stripos( $this->useragent , $this->engineXiino )>-1 )
             && !$this->DetectPalmWebOS() ); //Make sure it's not WebOS
  }
  ...
  function DetectDangerHiptop(){
    return ( stripos( $this->useragent , $this->deviceDanger )>-1
  ...
  function DetectOperaMobile(){
    return ( stripos( $this->useragent , $this->engineOpera )>-1
  ...
  function DetectWapWml(){
     return ( stripos( $this->httpaccept , $this->vndwap )>-1
  ...
  function DetectKindle(){
    return ( stripos( $this->useragent , $this->deviceKindle )>-1
             && !$this->DetectAndroid() );
  }
  ...
  function DetectNintendo(){
    return ( stripos( $this->useragent , $this->deviceNintendo )>-1
  ...
  function DetectMidpCapable(){
     return ( stripos( $this->useragent.'||'.$this->httpaccept , $this->deviceMidp )>-1 );
  }
  ...
  function DetectMaemoTablet(){
    ...
    return ( stripos( $this->useragent , $this->linux )>-1
             && stripos( $this->useragent , $this->deviceTablet )>-1
  ...
  function DetectTierRichCss(){
    if( !$this->DetectMobileQuick()
        || $this->DetectTierIphone() //Exclude iPhone Tier and e-Ink Kindle devices
        || $this->DetectKindle() )
      return false;
    
      
    //The following devices are explicitly ok.
    return ( $this->DetectWebkit() //Any WebKit
             || $this->DetectS60OssBrowser()
